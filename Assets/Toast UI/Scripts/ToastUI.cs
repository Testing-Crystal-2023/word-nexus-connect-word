...
namespace EasyUI.Helpers {
   ...
   public class ToastUI : MonoBehaviour {
      ...
      [SerializeField] private Image uiImage, iconImage;
      [SerializeField] private Sprite redBG,greenBG,redIcon,greenIcon;
      ...
      public void Init (string text, float duration, Color color, ToastPosition position) {
        ...
        public void SuccessInit(string text, float duration, ToastColor color, ToastPosition position)
        {
            SuccessShow(text, duration, colors[(int)color], position);
        }

        private void SuccessShow(string text, float duration, Color color, ToastPosition position)
        {
            uiImage.sprite = greenBG;
