...
namespace Game
{
	...
	/// </summary>
	public class RoyalWord_Tween : MonoBehaviour
	{
		#region Enums
		...
		/// </summary>
		public static RoyalWord_Tween GetTween(GameObject obj, TweenType tweenType)
		{
			if (obj == null)
			{
				return null;
			...
			RoyalWord_Tween[] tweens = obj.GetComponents<RoyalWord_Tween>();
		...
		{
			RoyalWord_Tween tweenObject = GetTween(obj, tweenType);
		...
		{
			RoyalWord_Tween[] tweenComponents = obj.GetComponents<RoyalWord_Tween>();
		...
		/// </summary>
		public static RoyalWord_Tween PositionX(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal = false, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween PositionY(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal = false, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween PositionZ(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal = false, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween ScaleX(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween ScaleY(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween ScaleZ(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween RotateX(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween RotateY(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween RotateZ(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween RotateAround(Transform transform, TweenStyle tweenStyle, Vector3 point, Vector3 axis, float angle, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// Rotates the GameObject around a point on the axis by the given angle
		/// </summary>
		public static RoyalWord_Tween RotateAround(Transform transform, TweenStyle tweenStyle, Transform point, Vector3 axis, float angle, float duration, LoopType loopType = LoopType.None)
		{
			return CreateRotationTween(transform.gameObject, TweenType.Rotation, tweenStyle, point, axis, angle, duration, loopType);
		}
		...
		/// </summary>
		public static RoyalWord_Tween Colour(UnityEngine.UI.Graphic uiGraphic, TweenStyle tweenStyle, Color fromValue, Color toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween Colour(Renderer renderer, TweenStyle tweenStyle, Color fromValue, Color toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static RoyalWord_Tween PivotX(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static RoyalWord_Tween PivotY(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static RoyalWord_Tween RectTransformWidth(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static RoyalWord_Tween RectTransformHeight(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static RoyalWord_Tween CanvasGroupAlpha(CanvasGroup canvasGroup, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public RoyalWord_Tween TweenRotationPoint(TweenStyle tweenStyle, Vector3 fromPoint, Vector3 toPoint, float duration, LoopType loopType = LoopType.None)
		{
			...
			RoyalWord_Tween tween = GetTween(this.gameObject, TweenType.RotationPoint);

			if (tween == null)
			{
				tween = this.gameObject.AddComponent<RoyalWord_Tween>();
			}
		...
		private static RoyalWord_Tween CreateTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal, LoopType loopType)
		{
			RoyalWord_Tween tween = GetTween(obj, tweenType);

			if (tween == null)
			{
				tween = obj.AddComponent<RoyalWord_Tween>();
			}
		...
		private static RoyalWord_Tween CreateRotationTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, Vector3 point, Vector3 axis, float angle, float duration, LoopType loopType)
		{
			RoyalWord_Tween tween = GetTween(obj, tweenType);
		...
		private static RoyalWord_Tween CreateRotationTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, Transform point, Vector3 axis, float angle, float duration, LoopType loopType)
		{
			RoyalWord_Tween tween = GetTween(obj, tweenType);
		...
		private static RoyalWord_Tween CreateColourTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, Color fromValue, Color toValue, float duration, LoopType loopType)
		{
			RoyalWord_Tween tween = GetTween(obj, tweenType);
		...
		{
			RoyalWord_Tween rotationTween = GetTween(this.gameObject, TweenType.Rotation);
