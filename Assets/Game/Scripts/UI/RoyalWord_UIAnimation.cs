...
namespace Game
{
	public class RoyalWord_UIAnimation : MonoBehaviour
	{
		#region Enums
				...
				if (elapsedTime >= duration)
				{
					...
					if (loopType != LoopType.None)
					{
						...
						if (loopType == LoopType.Reverse)
						{
							...
							RoyalWord_Utilities.SwapValue(ref fromValue, ref toValue);
							RoyalWord_Utilities.SwapValue(ref fromColor, ref toColor);
						}
		...
		{
			RoyalWord_UIAnimation[] uiAnimations = targetGameObject.GetComponents<RoyalWord_UIAnimation>();
		...
		public static RoyalWord_UIAnimation GetAnimation(GameObject targetGameObject, Type animType)
		{
			RoyalWord_UIAnimation[] uiAnimations = targetGameObject.GetComponents<RoyalWord_UIAnimation>();
		...
		public static List<RoyalWord_UIAnimation> GetAnimationsById(GameObject targetGameObject, string id)
		{
			RoyalWord_UIAnimation[] uiAnimations = targetGameObject.GetComponents<RoyalWord_UIAnimation>();
			List<RoyalWord_UIAnimation> returnAnimations = new List<RoyalWord_UIAnimation>();
		...
		private float GetLerpT(float time)
		{
			...
			{
				case Style.EaseIn:
					t = RoyalWord_Utilities.EaseIn(t);
					break;
				case Style.EaseOut:
					t = RoyalWord_Utilities.EaseOut(t);
					break;
				case Style.Custom:
		...
		public static RoyalWord_UIAnimation PositionX(RectTransform rectT, float to, float duration)
		{
			return CreateAnimation(Type.PositionX, rectT.gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation PositionX(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.PositionX, rectT.gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation PositionY(RectTransform rectT, float to, float duration)
		{
			return CreateAnimation(Type.PositionY, rectT.gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation PositionY(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.PositionY, rectT.gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation ScaleX(RectTransform rectT, float to, float duration)
		{
			return CreateAnimation(Type.ScaleX, rectT.gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation ScaleX(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.ScaleX, rectT.gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation ScaleY(RectTransform rectT, float to, float duration)
		{
			return CreateAnimation(Type.ScaleY, rectT.gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation ScaleY(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.ScaleY, rectT.gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation RotationZ(RectTransform rectT, float to, float duration)
		{
			return CreateAnimation(Type.RotationZ, rectT.gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation RotationZ(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.RotationZ, rectT.gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation Width(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.Width, rectT.gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation Width(RectTransform rectT, float to, float duration)
		{
			return CreateAnimation(Type.Width, rectT.gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation Height(RectTransform rectT, float from, float to, float duration)
		{
			return CreateAnimation(Type.Height, rectT.gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation Height(RectTransform rectT, float to, float duration)
		{
			return CreateAnimation(Type.Height, rectT.gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation Alpha(GameObject gameObject, float to, float duration)
		{
			return CreateAnimation(Type.Alpha, gameObject, true, 0, to, duration);
		}

		public static RoyalWord_UIAnimation Alpha(GameObject gameObject, float from, float to, float duration)
		{
			return CreateAnimation(Type.Alpha, gameObject, false, from, to, duration);
		}

		public static RoyalWord_UIAnimation Color(Graphic graphic, Color to, float duration)
		{
			return CreateColorAnimation(graphic.gameObject, true, UnityEngine.Color.white, to, duration);
		}

		public static RoyalWord_UIAnimation Color(Graphic graphic, Color from, Color to, float duration)
		{
			return CreateColorAnimation(graphic.gameObject, false, from, to, duration);
		}

		private static RoyalWord_UIAnimation CreateAnimation(Type type, GameObject gameObject, bool useCurrentFrom, float from, float to, float duration)
		{
			RoyalWord_UIAnimation uIAnimation = CreateUIAnimation(gameObject, type, duration, useCurrentFrom);
		...
		private static RoyalWord_UIAnimation CreateColorAnimation(GameObject gameObject, bool useCurrentFrom, Color from, Color to, float duration)
		{
			RoyalWord_UIAnimation uIAnimation = CreateUIAnimation(gameObject, Type.Color, duration, useCurrentFrom);
		...
		private static RoyalWord_UIAnimation CreateUIAnimation(GameObject gameObject, Type type, float duration, bool useCurrentFrom)
		{
			RoyalWord_UIAnimation uIAnimation = GetUIAnimation(gameObject, type);
		...
		private static RoyalWord_UIAnimation GetUIAnimation(GameObject gameObject, Type type)
		{
			RoyalWord_UIAnimation[] uIAnimations = gameObject.GetComponents<RoyalWord_UIAnimation>();
			RoyalWord_UIAnimation uIAnimation = null;
			...
			if (uIAnimation == null)
			{
				uIAnimation = gameObject.AddComponent<RoyalWord_UIAnimation>();
