...
namespace Game
{
	public class WordNexus_Word_BoardCell : WordNexus_UIMonoBehaviour
	{
		#region Enums
		...
		private void SetupAndPlay(WordNexus_UIAnimation anim, AnimationCurve animationCurve, float startDelay)
		{
