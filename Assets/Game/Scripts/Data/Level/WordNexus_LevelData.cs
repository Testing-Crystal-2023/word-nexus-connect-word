...
namespace Game
{
	public class WordNexus_LevelData
	{
		#region Enums
		...
		public WordNexus_LevelData(string contents)
		{
	...
	public class WordData
	{
		...
		public WordData(JSONNode levelWordJson, WordNexus_LevelData.Type levelType)
		{
			Word = levelWordJson["word"].Value;
			AwardCoins = levelWordJson["awardCoins"].AsBool;

			if (levelType == WordNexus_LevelData.Type.Grid)
			{
