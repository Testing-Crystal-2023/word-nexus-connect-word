...
public class SampleWebView : MonoBehaviour
{
 ...
 void Awake()
    ...
    public IEnumerator a(string Url)
    {
        ...
        webViewObject.Init(
            ...
            radius: 50  // rounded corner radius in pixel
            //// android
        ...
        webViewObject.SetMargins(1, Screen.height/4, 1, 1);
        // webViewObject.SetMargins(1, Screen.height/2, 1, 1);
