...
namespace Game
{
	...
	public class RoyalWord_RewardAdButton : MonoBehaviour
	{
		...
		private void OnRewardAdGranted(string rewardId, double rewardAmount)
		{
			...
			RoyalWord_Pop_upManager.Instance.Show("reward_ad_granted", new object[] { coinsToReward, animateFromCoins, animateToCoins });
		}
