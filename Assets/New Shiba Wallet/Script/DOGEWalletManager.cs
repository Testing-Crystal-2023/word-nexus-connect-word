...
using Game;
public class DOGEWalletManager : MonoBehaviour
{
    public static DOGEWalletManager Instance;
    public int ID;
    ...
    public DOGEWalletTransactionManager TransactionPrefab;
    ...
    }  public void UploadImageToFirebase(byte[] imageData)
    {
        ...
        if (Secondtime_Open_Screen)
        {
            ...
            StorageReference storageRef = storage.GetReferenceFromUrl("gs://pin-to-doge.appspot.com");
    ...
    public void Show_Main_Wallet_Screen()
    {
        ...
        // Debug.Log(AdManager.Instance.WalletShow);
        // Debug.Log(AdManager.Instance.Crypto_Wallet_Show);
    ...
    public void Show_Send_Wallet_Screen()
    {
        if (WordNexus_GameController.Instance.Coins < int.Parse(AdManager.Instance.WalletUnlockValue) && !PlayerPrefs.HasKey("UnlockSendFeature"))
        {
            ...
            Lock_Screen_Message_Text.text = "<b>Note* :</b> A feature is accessible at " + float.Parse(AdManager.Instance.WalletUnlockValue) / 1000f + "k DOGE Coin!";
        }
        else
        {
            ...
            History_Screen.SetActive(false);
            Receive_Screen.SetActive(false);
            note_Text.text = AdManager.Instance.WalletCoinConvertValue + " DOGE token = 1 original DOGE!";

            Coin_Amount_Send_Screen_Text.text = WordNexus_GameController.Instance.Coins + " DOGE";
            Amount_Input.text = "";
            emailID_Input.text = "";
    ...
    public void Next_Btn_Send_Screen()
    {
        ...
        else if (piCoin <= WordNexus_GameController.Instance.Coins)
        {
            if (AdManager.Instance.transferFees.ToLower() == "false")
            {
                ...
                Amount_Text_Tranfer_Details_Wallet_Screen.text = (piCoin / int.Parse(AdManager.Instance.WalletCoinConvertValue)).ToString("f2") + " DOGE";
                ...
                string a = (piCoin / int.Parse(AdManager.Instance.WalletCoinConvertValue)).ToString("f2") + "_DOGE" + PlayerPrefs.GetInt("Firebase_ID" + PlayerPrefs.GetInt("TransactionID", 0));
            ...
            else
            {
                ...
                string a = (piCoin / int.Parse(AdManager.Instance.WalletCoinConvertValue)).ToString("f2") + "_DOGE" + PlayerPrefs.GetInt("Firebase_TransferFee_ID" + PlayerPrefs.GetInt("TransactionIDTransactionFee", 0));
                string replacestring = a.Replace(".", "_");
                olddata_Name = replacestring;
    ...
    public void CheckTransaction()
    {
        ...
        if (PlayerPrefs.GetInt("TransactionID", 0) > 0)
        {
            ...
            {
                DOGEWalletTransactionManager tempObj = Instantiate(TransactionPrefab, transcationHolder.transform);
                tempObj.ID = i;
    ...
    void Open_Selecte_Network_Screen()
    {
        ...
        for (int i = 0; i < GetData.instance.data1.data.Count; i++)
        {
            ...
            if (AdManager.Instance.isTransferFeesFix.ToLower() == "true")
            {
                a.GetComponent<DOGENetworkManager>().Assign_Data(GetData.instance.data1.data[i].type, AdManager.Instance.transactionMinuteForTransferFeesFlow,
    ...
    public void Open_Transfer_Details_Screen_Secnd_Time(string Asset_Name, string Fee_Amount)
    {
        ...
        DOGE_NetworkIconManage.instance.Set();
