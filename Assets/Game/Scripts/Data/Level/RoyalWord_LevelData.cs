...
namespace Game
{
	public class RoyalWord_LevelData
	{
		#region Enums
		...
		public RoyalWord_LevelData(string contents)
		{
	...
	public class WordData
	{
		...
		public WordData(JSONNode levelWordJson, RoyalWord_LevelData.Type levelType)
		{
			Word = levelWordJson["word"].Value;
			AwardCoins = levelWordJson["awardCoins"].AsBool;

			if (levelType == RoyalWord_LevelData.Type.Grid)
			{
