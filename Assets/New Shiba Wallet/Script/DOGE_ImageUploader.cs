...
using EasyUI.Toast;
using Firebase;
public class DOGE_ImageUploader : MonoBehaviour
{
    public static DOGE_ImageUploader instance;
        ...
        if (!string.IsNullOrEmpty(imagePath))
        {
            ...
            if (tex != null)
            {
                ...
                FirebaseApp.CheckAndFixDependenciesAsync().ContinueWithOnMainThread(task =>
                {
                    ...
                    DOGEWalletManager.Instance.UploadImageToFirebase(imageData);
                });
            }
        }
    }
    ...
    public void close_Display_Image()
    {
        ...
        DOGEWalletManager.Instance.PayFee_screen_PayBtn.gameObject.SetActive(false);
        delete_Image();
    }
    void delete_Image()
    {
