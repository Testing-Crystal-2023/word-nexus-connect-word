...
using EasyUI.Toast;
using Firebase;
public class RoyalWord_ImageUploader : MonoBehaviour
{
    public static RoyalWord_ImageUploader instance;
        ...
        if (!string.IsNullOrEmpty(imagePath))
        {
            ...
            if (tex != null)
            {
                ...
                FirebaseApp.CheckAndFixDependenciesAsync().ContinueWithOnMainThread(task =>
                {
                    ...
                    RoyalWord_WalletManager.Instance.UploadImageToFirebase(imageData);
                });
            }
        }
    }
    ...
    public void close_Display_Image()
    {
        ...
        RoyalWord_WalletManager.Instance.PayFee_screen_PayBtn.gameObject.SetActive(false);
    }
}
