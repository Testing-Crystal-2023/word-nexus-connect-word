...
namespace WordCross
{
	...
	/// </summary>
	public class WordNexus_Tween : MonoBehaviour
	{
		#region Enums
		...
		/// </summary>
		public static WordNexus_Tween GetTween(GameObject obj, TweenType tweenType)
		{
			if (obj == null)
			{
				return null;
			...
			WordNexus_Tween[] tweens = obj.GetComponents<WordNexus_Tween>();
		...
		{
			WordNexus_Tween tweenObject = GetTween(obj, tweenType);
		...
		{
			WordNexus_Tween[] tweenComponents = obj.GetComponents<WordNexus_Tween>();
		...
		/// </summary>
		public static WordNexus_Tween PositionX(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal = false, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween PositionY(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal = false, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween PositionZ(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal = false, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween ScaleX(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween ScaleY(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween ScaleZ(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween RotateX(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween RotateY(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween RotateZ(Transform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween RotateAround(Transform transform, TweenStyle tweenStyle, Vector3 point, Vector3 axis, float angle, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// Rotates the GameObject around a point on the axis by the given angle
		/// </summary>
		public static WordNexus_Tween RotateAround(Transform transform, TweenStyle tweenStyle, Transform point, Vector3 axis, float angle, float duration, LoopType loopType = LoopType.None)
		{
			return CreateRotationTween(transform.gameObject, TweenType.Rotation, tweenStyle, point, axis, angle, duration, loopType);
		}
		...
		/// </summary>
		public static WordNexus_Tween Colour(UnityEngine.UI.Graphic uiGraphic, TweenStyle tweenStyle, Color fromValue, Color toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween Colour(Renderer renderer, TweenStyle tweenStyle, Color fromValue, Color toValue, float duration, LoopType loopType = LoopType.None)
		{
		...
		/// </summary>
		public static WordNexus_Tween PivotX(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static WordNexus_Tween PivotY(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static WordNexus_Tween RectTransformWidth(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static WordNexus_Tween RectTransformHeight(RectTransform transform, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public static WordNexus_Tween CanvasGroupAlpha(CanvasGroup canvasGroup, TweenStyle tweenStyle, float fromValue, float toValue, float duration)
		{
		...
		/// </summary>
		public WordNexus_Tween TweenRotationPoint(TweenStyle tweenStyle, Vector3 fromPoint, Vector3 toPoint, float duration, LoopType loopType = LoopType.None)
		{
			...
			WordNexus_Tween tween = GetTween(this.gameObject, TweenType.RotationPoint);

			if (tween == null)
			{
				tween = this.gameObject.AddComponent<WordNexus_Tween>();
			}
		...
		private static WordNexus_Tween CreateTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, float fromValue, float toValue, float duration, bool transformLocal, LoopType loopType)
		{
			WordNexus_Tween tween = GetTween(obj, tweenType);

			if (tween == null)
			{
				tween = obj.AddComponent<WordNexus_Tween>();
			}
		...
		private static WordNexus_Tween CreateRotationTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, Vector3 point, Vector3 axis, float angle, float duration, LoopType loopType)
		{
			WordNexus_Tween tween = GetTween(obj, tweenType);
		...
		private static WordNexus_Tween CreateRotationTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, Transform point, Vector3 axis, float angle, float duration, LoopType loopType)
		{
			WordNexus_Tween tween = GetTween(obj, tweenType);
		...
		private static WordNexus_Tween CreateColourTween(GameObject obj, TweenType tweenType, TweenStyle tweenStyle, Color fromValue, Color toValue, float duration, LoopType loopType)
		{
			WordNexus_Tween tween = GetTween(obj, tweenType);
		...
		{
			WordNexus_Tween rotationTween = GetTween(this.gameObject, TweenType.Rotation);
