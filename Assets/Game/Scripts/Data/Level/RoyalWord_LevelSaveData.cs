...
namespace Game
{
	public class RoyalWord_LevelSaveData
	{
		...
		public RoyalWord_LevelSaveData(RoyalWord_LevelData levelData)
		{
			Initialize(levelData);
		}

		public RoyalWord_LevelSaveData(JSONNode savedData)
		{
			LoadSave(savedData);
		}
		...
		/// </summary>
		private void Initialize(RoyalWord_LevelData levelData)
		{
			InitializeHintIndices(levelData);

			if (levelData.LevelType == RoyalWord_LevelData.Type.Grid)
			{
		...
		/// </summary>
		private void InitializeCharacterGrid(RoyalWord_LevelData levelData)
		{
		...
		/// </summary>
		private void InitializeHintIndices(RoyalWord_LevelData levelData)
		{
			for (int i = 0; i < levelData.Words.Count; i++)
			{
