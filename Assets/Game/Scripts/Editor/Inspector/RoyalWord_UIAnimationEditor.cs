...
namespace Game
{
	[CustomEditor(typeof(RoyalWord_UIAnimation))]
	public class RoyalWord_UIAnimationEditor : Editor
	{
		...
		public override void OnInspectorGUI()
		{
			...
			if (serializedObject.FindProperty("style").enumValueIndex == (int)RoyalWord_UIAnimation.Style.Custom)
			{
			...
			switch ((RoyalWord_UIAnimation.Type)serializedObject.FindProperty("type").enumValueIndex)
			{
				case RoyalWord_UIAnimation.Type.PositionX:
				case RoyalWord_UIAnimation.Type.PositionY:
				case RoyalWord_UIAnimation.Type.ScaleX:
				case RoyalWord_UIAnimation.Type.ScaleY:
				case RoyalWord_UIAnimation.Type.RotationZ:
				case RoyalWord_UIAnimation.Type.Width:
				case RoyalWord_UIAnimation.Type.Height:
				case RoyalWord_UIAnimation.Type.Alpha:
					DrawFloatValues();
					break;
				case RoyalWord_UIAnimation.Type.Color:
					DrawColorValues();
					break;
			}
