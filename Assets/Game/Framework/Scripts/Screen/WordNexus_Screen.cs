...
namespace Game
{
	public class WordNexus_Screen : AdjustRectTransformForSafeArea
	{
		#region Classes

		[System.Serializable]
		private class WordNexus_OnTransitionEvent : UnityEngine.Events.UnityEvent { }

		[System.Serializable]
		private class WordNexus_TransitionInfo
		{
			public enum Type
			{
				Fade,
			...
			public WordNexus_OnTransitionEvent onTransition = null;
		}
		...
		[Space]
		[SerializeField] private WordNexus_TransitionInfo showTransition = null;
		[SerializeField] private WordNexus_TransitionInfo hideTransition = null;
		...
		private void Transition(WordNexus_TransitionInfo transitionInfo, bool back, bool immediate, bool show)
		{
			if (transitionInfo.animate)
			{
				...
				{
					case WordNexus_TransitionInfo.Type.Fade:
						StartFadeAnimation(transitionInfo, show, animationDuration);
						break;
					case WordNexus_TransitionInfo.Type.Swipe:
		...
		/// </summary>
		private void StartFadeAnimation(WordNexus_TransitionInfo transitionInfo, bool show, float duration)
		{
		...
		/// </summary>
		private void StartSwipeAnimation(WordNexus_TransitionInfo transitionInfo, bool show, bool back, float duration)
		{
