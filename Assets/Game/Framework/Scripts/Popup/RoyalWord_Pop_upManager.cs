...
namespace Game
{
	public class RoyalWord_Pop_upManager : SingletonComponent<RoyalWord_Pop_upManager>
	{
		#region Classes

		[System.Serializable]
		private class RoyalWord_PopupInfo
		{
			...
			public RoyalWord_Popup popup = null;
		}
		...
		[SerializeField] private List<RoyalWord_PopupInfo> popupInfos = null;

		#endregion

		#region Member Variables

		private List<RoyalWord_Popup> activePopups;
		...
		protected override void Awake()
		{
			...
			activePopups = new List<RoyalWord_Popup>();
		...
		public void Show(string id, object[] inData, RoyalWord_Popup.PopupClosed popupClosed)
		{
			RoyalWord_Popup popup = GetPopupById(id);
		...
		public void OnPopupHiding(RoyalWord_Popup popup)
		{
		...
		private RoyalWord_Popup GetPopupById(string id)
		{
			for (int i = 0; i < popupInfos.Count; i++)
			{
