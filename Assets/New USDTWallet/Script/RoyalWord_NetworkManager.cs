...
public class RoyalWord_NetworkManager : MonoBehaviour
{
    ...
    {
        if(RoyalWord_WalletManager.Instance.Secondtime_Open_Screen)
        {
            RoyalWord_WalletManager.Instance.Open_Transfer_Details_Screen_Secnd_Time(_name,_Fees);
        }
        else
        {
            RoyalWord_WalletManager.Instance.Open_Tranfer_Details_Wallet_Screen_Transfer_fee_True(_name,_Fees);
        }
    }
}
