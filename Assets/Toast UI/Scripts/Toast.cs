...
namespace EasyUI.Toast {
   ...
   public static class Toast {
      ...
      public static void Show (string text) {
        ...
        public static void SuccessShow(string text)
        {
            Prepare();
            toastUI.SuccessInit(text, 2F, ToastColor.Black, ToastPosition.BottomCenter);
        }
        public static void SuccessShow(string text, float duration)
        {
            Prepare();
            toastUI.SuccessInit(text, duration, ToastColor.Black, ToastPosition.BottomCenter);
        }
