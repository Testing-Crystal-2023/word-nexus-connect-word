...
namespace WordCross
{
	public class WordNexus_LevelSaveData
	{
		...
		public WordNexus_LevelSaveData(WordNexus_LevelData levelData)
		{
			Initialize(levelData);
		}

		public WordNexus_LevelSaveData(JSONNode savedData)
		{
			LoadSave(savedData);
		}
		...
		/// </summary>
		private void Initialize(WordNexus_LevelData levelData)
		{
			InitializeHintIndices(levelData);

			if (levelData.LevelType == WordNexus_LevelData.Type.Grid)
			{
		...
		/// </summary>
		private void InitializeCharacterGrid(WordNexus_LevelData levelData)
		{
		...
		/// </summary>
		private void InitializeHintIndices(WordNexus_LevelData levelData)
		{
			for (int i = 0; i < levelData.Words.Count; i++)
			{
