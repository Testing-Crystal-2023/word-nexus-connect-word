...
namespace WordCross
{
	public class WordNexus_CubicSpline
	{
		#region Fields
		...
		public WordNexus_CubicSpline(float[] x, float[] y, float startSlope = float.NaN, float endSlope = float.NaN, bool debug = false)
		{
		...
		public void Fit(float[] x, float[] y, float startSlope = float.NaN, float endSlope = float.NaN, bool debug = false)
		{
			...
			WordNexus_TriDiagonalMatrix m = new WordNexus_TriDiagonalMatrix(n);
		...
		{
			WordNexus_CubicSpline spline = new WordNexus_CubicSpline();
			...
			float firstDx = Single.NaN, float firstDy = Single.NaN, float lastDx = Single.NaN, float lastDy = Single.NaN)
		{
			...
			WordNexus_CubicSpline xSpline = new WordNexus_CubicSpline();
			xs = xSpline.FitAndEval(dists, x, times, firstDx / dt, lastDx / dt);

			WordNexus_CubicSpline ySpline = new WordNexus_CubicSpline();
