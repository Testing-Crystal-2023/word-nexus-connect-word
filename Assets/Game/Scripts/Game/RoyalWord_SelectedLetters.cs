...
namespace Game
{
	public class RoyalWord_SelectedLetters : MonoBehaviour
	{
		...
		public void SetSelectedLetters(string selectedLetters, Color packColor)
		{
			...
			RoyalWord_UIAnimation.DestroyAllAnimations(container);
			RoyalWord_UIAnimation.DestroyAllAnimations(backgroundImage.gameObject);
		...
		private IEnumerator Shake()
		{
			...
			RoyalWord_UIAnimation anim = RoyalWord_UIAnimation.PositionX(container.transform as RectTransform, 0, ShakeAnimDuration);
		...
		{
			RoyalWord_UIAnimation anim = RoyalWord_UIAnimation.PositionX(container.transform as RectTransform, -ShakeAmount, animDuration);
		...
		{
			RoyalWord_UIAnimation anim = RoyalWord_UIAnimation.Alpha(container, 0f, FadeAnimDuration);
		...
		private void FadeOutBackground()
		{
			...
			RoyalWord_UIAnimation anim = RoyalWord_UIAnimation.Color(backgroundImage, fromColor, toColor, FadeAnimDuration);
		...
		private void FadeUpText()
		{
			...
			anim = RoyalWord_UIAnimation.Color(selectTextCopy, fromColor, toColor, FadeAnimDuration);
			...
			anim = RoyalWord_UIAnimation.PositionY(selectedTextCopyRectT, fromY, toY, FadeAnimDuration);
			anim.style = RoyalWord_UIAnimation.Style.EaseOut;
			anim.Play();
		}
		...
		private void FadeTextTo(RectTransform animateTo)
		{
			...
			anim = RoyalWord_UIAnimation.Color(selectTextCopy, fromColor, toColor, FadeAnimDuration);
			anim.style = RoyalWord_UIAnimation.Style.EaseIn;
			anim.Play();

			// Move the selected text copy
			Vector2 toPosition = RoyalWord_Utilities.SwitchToRectTransform(animateTo, transform as RectTransform);

			anim = RoyalWord_UIAnimation.PositionX(selectTextCopy.transform as RectTransform, toPosition.x, FadeAnimDuration);
			anim.style = RoyalWord_UIAnimation.Style.EaseOut;
			anim.Play();

			anim = RoyalWord_UIAnimation.PositionY(selectTextCopy.transform as RectTransform, toPosition.y, FadeAnimDuration);
			anim.style = RoyalWord_UIAnimation.Style.EaseOut;
			anim.Play();

			// Scale them to 0
			anim = RoyalWord_UIAnimation.ScaleX(selectTextCopy.transform as RectTransform, 0.2f, FadeAnimDuration);
			anim.style = RoyalWord_UIAnimation.Style.EaseIn;
			anim.Play();

			anim = RoyalWord_UIAnimation.ScaleY(selectTextCopy.transform as RectTransform, 0.2f, FadeAnimDuration);
			anim.style = RoyalWord_UIAnimation.Style.EaseIn;
			anim.Play();
		}
