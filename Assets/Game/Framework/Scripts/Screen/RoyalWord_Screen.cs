...
namespace Game
{
	public class RoyalWord_Screen : AdjustRectTransformForSafeArea
	{
		#region Classes

		[System.Serializable]
		private class RoyalWord_OnTransitionEvent : UnityEngine.Events.UnityEvent { }

		[System.Serializable]
		private class RoyalWord_TransitionInfo
		{
			public enum Type
			{
				Fade,
			...
			public RoyalWord_OnTransitionEvent onTransition = null;
		}
		...
		[Space]
		[SerializeField] private RoyalWord_TransitionInfo showTransition = null;
		[SerializeField] private RoyalWord_TransitionInfo hideTransition = null;
		...
		private void Transition(RoyalWord_TransitionInfo transitionInfo, bool back, bool immediate, bool show)
		{
			if (transitionInfo.animate)
			{
				...
				{
					case RoyalWord_TransitionInfo.Type.Fade:
						StartFadeAnimation(transitionInfo, show, animationDuration);
						break;
					case RoyalWord_TransitionInfo.Type.Swipe:
		...
		/// </summary>
		private void StartFadeAnimation(RoyalWord_TransitionInfo transitionInfo, bool show, float duration)
		{
		...
		/// </summary>
		private void StartSwipeAnimation(RoyalWord_TransitionInfo transitionInfo, bool show, bool back, float duration)
		{
