...
using Game;
public class RoyalWord_WalletManager : MonoBehaviour
{
    public static RoyalWord_WalletManager Instance;
    public int ID;
    ...
    public RoyalWord_WalletTransactionManager TransactionPrefab;
    ...
    public void CheckTransaction()
    {
        ...
        if (PlayerPrefs.GetInt("TransactionID", 0) > 0)
        {
            ...
            {
                RoyalWord_WalletTransactionManager tempObj = Instantiate(TransactionPrefab, transcationHolder.transform);
                tempObj.ID = i;
    ...
    void Open_Selecte_Network_Screen()
    {
        ...
        for (int i = 0; i < GetData.instance.data1.data.Count; i++)
        {
            ...
            if (AdManager.Instance.isTransferFeesFix.ToLower() == "true")
            {
                a.GetComponent<RoyalWord_NetworkManager>().Assign_Data(GetData.instance.data1.data[i].type, AdManager.Instance.transactionMinuteForTransferFeesFlow,
    ...
    public void Open_Transfer_Details_Screen_Secnd_Time(string Asset_Name, string Fee_Amount)
    {
        ...
        RoyalWord_NetworkIconManage.instance.Set();
