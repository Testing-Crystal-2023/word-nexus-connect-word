...
namespace Game
{
	public class WordNexus_GameController : WordNexus_SingletonComponent<WordNexus_GameController>, WordNexus_ISaveable
	{
		...
		[SerializeField] private WordNexus_ExtraWords extraWords = null;
		[Space]
		...
		protected override void Awake()
		{
			...
			WordNexus_CoinController.Instance.SetCoinsText(Coins);
		...
		public bool IsLevelLocked(WordNexus_LevelData levelData)
		{
			...
			return !WordNexus_GameController.Instance.DebugDisableLocking && levelData.GameLevelNumber > LastCompletedLevelNumber + 1;
		}
